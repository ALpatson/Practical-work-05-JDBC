...
/**
 * Factory for creating SQLite DataSource connections.
 * Uses singleton pattern - only one DataSource is created and reused.
 */
public class DataSourceFactory {
	...
	public static DataSource getDataSource() {
		if (dataSource == null) {
			...
			dataSource.setUrl("jdbc:sqlite:movies.db");
		}
		return dataSource;
	}
}